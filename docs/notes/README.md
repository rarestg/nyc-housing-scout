...
Observations, field notes, strategy brainstorms, and superseded docs.
...
| [2026-03-13_13-16-00_BROWSER_RELAY_INGESTION_SOP](2026-03-13_13-16-00_BROWSER_RELAY_INGESTION_SOP.md) | Live browser-relay ingestion SOP — tested commands, loop policy, quirks, and schema note |
| [2026-03-13_13-37-00_INGEST_LOOP_SPEC](2026-03-13_13-37-00_INGEST_LOOP_SPEC.md) | Implementation spec for a small `ingest:loop` CLI over the existing browser relay + queue path |

### Superseded

These have been replaced by newer docs but kept for historical reference.
