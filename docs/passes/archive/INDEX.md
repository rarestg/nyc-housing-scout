...
Foundational-phase implementation passes from 2026-03-12 and 2026-03-13, moved here during the 2026-03-18 documentation cleanup pass.

## Why These Were Moved

These passes describe work that is now complete and documented in canonical docs (`docs/PIPELINE.md`, `docs/VISION_AND_ARCHITECTURE.md`, `docs/ROADMAP.md`, `docs/LISTING_SCHEMA.md`). They are the project's day-1 and day-2 implementation logs covering initial pipeline structure, storage, collection, queue/processing, and Gemini integration.

## When To Read These

- historical archaeology: understanding how early implementation decisions were made
- debugging: if a current issue traces back to foundational collector, storage, or queue behavior
- onboarding context: seeing how the system evolved from its first passes

## Current Sources Of Truth

- `docs/passes/README.md` for the active pass index (03-15 through 03-17)
- `docs/PIPELINE.md` for current operational behavior
- `docs/VISION_AND_ARCHITECTURE.md` for architectural principles

## Archived Files

### 2026-03-12 — Project Bootstrap And Foundation
...
### 2026-03-13 — Processing Pipeline And Queue Foundation
...
| [2026-03-13_02-26-11_MISSING_PERMALINK_DEBUG_CAPTURE_PASS](2026-03-13_02-26-11_MISSING_PERMALINK_DEBUG_CAPTURE_PASS.md) | Debug | Permalink debug capture and investigation |
...
| [2026-03-13_08-56-33_SAME_BATCH_RECLAIM_FIX_PASS](2026-03-13_08-56-33_SAME_BATCH_RECLAIM_FIX_PASS.md) | Queue hardening | Excluded already-handled jobs from later claims in the same batch, exact timeout reclaim regression coverage |
| [2026-03-13_13-00-50_GEMINI_OUTPUT_QUALITY_REVIEW_PASS](2026-03-13_13-00-50_GEMINI_OUTPUT_QUALITY_REVIEW_PASS.md) | Gemini quality | Gemini output quality review and findings |
| [2026-03-13_14-18-18_PROMPT_GUARDRAIL_PASS_FOR_AMBIGUOUS_GEMINI_SCALARS](2026-03-13_14-18-18_PROMPT_GUARDRAIL_PASS_FOR_AMBIGUOUS_GEMINI_SCALARS.md) | Gemini prompting | Prompt guardrails for ambiguous scalar extraction |
...
| [2026-03-13_17-18-26_PHASE1_BACKFILL_SESSION_AND_DEBUG_PASS](2026-03-13_17-18-26_PHASE1_BACKFILL_SESSION_AND_DEBUG_PASS.md) | Live backfill ops | Ran a real Williamsburg Phase 1 loop session to saturation, verified fresh-only queue behavior |
